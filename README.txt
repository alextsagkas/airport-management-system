...
λειτουργικότητα για τον χειρισμό Red Black Trees (RBT). Οι δύο άλλες ενότητες int και string 
...
codebase. Συγκεκριμένα, έχουν χρησιμοποιηθεί τα παρακάτω, με αντίστοιχη αρίθμηση που 
χρησιμοποιείται και στις διαφάνειες:
    ...
    3. Διαχείρηση πόρων με συνέπεια. Συγκεκριμένα, τα malloc και free γίνονται μέσω συναρτήσεων (άμεσα ή έμμεσα) των ενοτήτων, με καλά ορισμένες διεπαφές, και όχι από τον χρήστη. 
    Συγκεκριμένα, η ενότητα rbt περιέχει τις συναρτήσεις RBT_create_tree και RBT_delete_tree, όπου 
    δημιουργείται και καταστρέφεται το struct που αντιπροσωπεύει το RBT. Επιπλέον, μέσω των 
    συνατήσεων RBT_insert και RBT_delete γίνεται έμμεση δημιουργία και καταστροφή κόμβων στον εκάστοτε RBT. Από την άλλη πλευρά, οι ενότητες που διαχειρίζονται τα keys υποστηρίζουν μόνο 
    άμεση δημιουργία και καταστροφή keys μέσω των συναρτήσεων int_create_key και int_delete_key, 
    της ενότητας int, και των string_create_key και string_delete_key, της ενότητας string, 
    αντίστοιχα.
    ...
    Συγκερκιμένα, αναφέρεται μία σύντομη περιγραφή (descritpion) της λειτουργικότητας κάθε 
...
Τέλος, η τύπωση των κλειδιών γίνεται με την χρήση της συνάρτησης print. Στα ονόματα των συναρτήσεων 
που αναφέρθηκαν προστίθεται το πρόθεμα του τύπου δεδομένων που χειρίζονται, που για λόγους 
ευκρίνειας αποσιωπήθηκε. Για να χρησιμοποιηθεί αυτή η λειτουργικότητα από την ενότητα του RBT, σε 
όποιες συναρτήσεις της χρειάζεται, έχει προστεθεί σαν επιπλέον παράμετρος δείκτης σε συνάρτηση.
